...
public class StoryFragment extends Fragment {
    ...
    private EditText editTextStory_isi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText editTextTittle = view.findViewById(R.id.editTextTittle);
        EditText editTextPart = view.findViewById(R.id.editTextPart);
        EditText editTextStory_isi = view.findViewById(R.id.editTextStory_isi);
